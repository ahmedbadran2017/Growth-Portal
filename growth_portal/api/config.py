...
CATALOGUE = [
    ...
    {"source": "shopify", "label": "Shopify", "timezone": "Africa/Casablanca",
     "maturity_hours": 12, "credential_key": "shopify_access_token", "covers": "Sessions, add-to-cart, checkout"},
    ...
    {"source": "clarity", "label": "Microsoft Clarity", "timezone": "UTC",
     "maturity_hours": 24, "credential_key": "clarity_api_token", "covers": "Rage clicks, dead clicks, scroll depth"},
